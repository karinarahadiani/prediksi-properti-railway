...
async def add_properti(item: Item):
	...
	if not item_found:
		data['properti'].append(item_dict)
...
#core 
@app.get('/kenaikan/{item_id}/{jangka_tahun}/{luas_tanah}')
